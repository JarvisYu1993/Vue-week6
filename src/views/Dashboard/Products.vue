<template>
  <div class="container pt-4">
    ...
    <product-modal ref="productModal" :product="tempProduct" :is-new="isNew" @update-product="updateProduct"></product-modal>
    <delProduct-modal ref="delProductModal" :delete-item="tempProduct" @delete="getProductList"></delProduct-modal>
  </div>
</template>
